...
<div class="constitution">
    ...
    <p> Taxi Spots (Restricted to rookies in the current league season. Allow unlimited amount of transfers from/to taxi squad throughout the season. Once a player is transferred to starting lineup/bench, they cannot be place back on Taxi Squad. You can claim rookies from waivers and place them on taxi squad.)</p>
    ...
    <p>Trading of players and draft picks (up to 3 drafts away) are allowed. Trades will process immediately and will be reversed if vetoed or under investigation for collusion. Tradable assets include players, draft picks, and FAAB $. Any trades containing future year's picks requires the team owner to pay league fees for that future season.</p>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>All trades that are found guilty of collusion will be reversed/denied. If the trade had affected the outcome of previous games, the results of those games will be revised.</li>
            <li>The commisioner will err on the side of letting owners manage their teams the way they see fit. Any collusion will need to be clear. The commissioner reserves the right to step in and at the very least, assess the thinking of any team involved in a heavily lop-sided trade.</li>
        </ul>
    ...
    <div class="subBlock">
        ...
        <p>While player lending is prohibited, GM's can execute conditional trades where performance thresholds are required that might result in additional assets going to one of the teams involved in the trade.</p>
        <p>If a trade has a condition assigned, the trade must first be approved by the Co-Commissioners and documented in the league's Central Registry. </p>
    </div>
    
    <h4 bind:this={oneTwoThree}>1.2.3 Trade Deadline</h4>
    <div class="subBlock">
        <p>The trade deadline will be set for the Sunday of the week 13 games of the NFL season.</p>
    </div>
    ...
    <div class="subBlock">
        <p>There are NO vetos in GGG. Any trades suspected to be a result of collusion will be reviewed by the Rules Committee. Any Rules Committee vote requires a majority vote to be passed.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $200. $0 bids are allowed. Bids will process Wednesday at 3AM EST.</p>
    ...
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s regular season standings and playoff standings.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 3 round of drafting, with 1 hour alotted for each pick. To make room for the incoming players, benches will be expanded by (5) spots. These spots will be removed in mid-August, at which point you will need to have cut the necessary players.</p>
    <p>Any spots not filled during the draft, can be filled immediately afterwards from the waiver wire.</p>

    <p>All league fees MUST be paid at the time of the rookie draft.</p>
    ...
    <p>At the end of the season 8 teams will make the playoffs. The first round of playoffs will commence in week 15. The top 8 teams by record will receive a playoff berth. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>In the VERY rare case that a manager is removed or leaves the league, the Rules Committee will convene to determine a course of action. </p>

    <h2 class="sectionHeading" bind:this={seven}>Section 7 League Finances</h2>
    
    <h3 bind:this={sevenOne}>7.1 League Dues</h3>
    <p>League dues are set at $20. Dues are collected through Venmo and must be paid by the rookie draft each season. All managers must pay for the next two seasons each year. In the event that a manager fails to pay before the deadline, a 10% penalty will be added to their payment and will go towards the payouts at the end of the year.</p>
    ...
    <ul>
        <li>1st place: $180</li>
        <li>2nd place: $20</li>
        <li>Most Points Against (regular season) $20</li>
    </ul>
